const redirect = {
    ...
    "picosx": {
        "name": "PicoSX",
        "icon": "<svg fill=\"none\" viewBox=\"0 0 182 182\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
            "<g clip-path=\"url(#a)\">\n" +
            "<path d=\"m94.838 4c0-2.2091 1.7908-4 4-4h5.8779c26.428 0 46.183 6.3836 59.264 19.151 12.013 11.696 18.02 28.258 18.02 49.685 0 19.017-6.229 34.329-18.687 45.935-13.259 12.321-31.546 18.481-54.86 18.481h-9.6149c-2.2092 0-4-1.79-4-4v-125.25zm-95.838 0c0-2.2091 1.7909-4 4-4h63.812c2.2092 0 4 1.7909 4 4v174c0 2.209-1.7908 4-4 4h-63.812c-2.2091 0-4-1.791-4-4v-174z\" fill=\"#fff\"/>\n" +
            "</g>\n" +
            "<defs>\n" +
            "<clipPath id=\"a\">\n" +
            "<rect width=\"182\" height=\"182\" rx=\"12\" fill=\"#fff\"/>\n" +
            "</clipPath>\n" +
            "</defs>\n" +
            "</svg>\n",
